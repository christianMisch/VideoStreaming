...
var createScene = function () {
  ...
  var myPlane = BABYLON.MeshBuilder.CreatePlane("myPlane", { width: 3, height: 1.75 }, scene);
  myPlane.rotate(BABYLON.Axis.Z, Math.PI, BABYLON.Space.WORLD);
  myPlane.rotate(BABYLON.Axis.Y, Math.PI, BABYLON.Space.WORLD);
  myPlane.position = new BABYLON.Vector3(-0.5, 1.5, 1);
  ...
  BABYLON.SceneLoader.ImportMesh("", "https://models.babylonjs.com/Chair/", "Chair.obj", scene, function (meshes) {
    //scene.createDefaultCameraOrLight(true, true, true);
    //scene.createDefaultEnvironment();
    meshes.forEach((mesh) => mesh.scaling = new BABYLON.Vector3(0.02, 0.02, 0.02));
    meshes.forEach((mesh) => mesh.position = new BABYLON.Vector3(-1.5, 0, 0.02));

    // get the sample texture for the chair
    var materialChair = new BABYLON.StandardMaterial("https://www.babylonjs-playground.com/textures/amiga.jpg", scene);
    materialChair.diffuseTexture = new BABYLON.Texture("https://www.babylonjs-playground.com/textures/amiga.jpg", scene);
    // mesh will render the sample texture
    meshes.forEach((mesh) => mesh.material = materialChair);
  });
  ...
  BABYLON.SceneLoader.ImportMesh("", "https://models.babylonjs.com/Chair/", "Chair.obj", scene, function (meshes) {
    ...
    //scene.createDefaultEnvironment();
    meshes.forEach((mesh) => mesh.scaling = new BABYLON.Vector3(0.02, 0.02, 0.02));
    meshes.forEach((mesh) => mesh.position = new BABYLON.Vector3(0.75, 0, 0.02));
  });
